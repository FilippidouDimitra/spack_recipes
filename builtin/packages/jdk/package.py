...
class Jdk(Package):
    ...
    version('18.0.0.1', sha256='dbabd3f726775a63329254b001b4190c082206e38323950b2db478606f1d65fa',url='https://download.oracle.com/java/18/latest/jdk-18_linux-x64_bin.tar.gz')
