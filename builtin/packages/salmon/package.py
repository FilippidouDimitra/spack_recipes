...
class Salmon(CMakePackage):
    ...
    url      = "https://github.com/COMBINE-lab/salmon/archive/refs/tags/v0.8.2.tar.gz"

    version('1.8.0', sha256='16720a5eb92771ddb8c594dfc32f2af8d950372aa0df131ba99a837e6fc81c2e')
