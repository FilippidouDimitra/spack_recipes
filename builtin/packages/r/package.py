...
class R(AutotoolsPackage):
    ...
    tatistical computing and graphics which provides a wide variety of
    ...
    def configure_args(self):
        ...
        config_args = [
            ...
            '--enable-R-shlib=yes',
            '--with-lapack=yes',
            '--with-blas=-L/mnt/fsx/spack/linux-amzn2-skylake_avx512/gcc-7.3.1/intel-mkl-2020.4.304-elf6dhrkovlfx3rgjaxohpre3ddsvc6c/mkl/lib/intel64/ -L/mnt/fsx/spack/linux-amzn2-skylake_avx512/gcc-7.3.1/intel-mkl-2020.4.304-elf6dhrkovlfx3rgjaxohpre3ddsvc6c/compilers_and_libraries_2020.4.304/linux/compiler/lib/intel64_lin/ -Wl,--start-group -lmkl_gf_lp64 -lmkl_gnu_thread -lmkl_core -lm -Wl,--end-group -liomp5 -lpthread',
