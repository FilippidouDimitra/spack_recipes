...
class Vmd(Package):
    ...
    version('1.9.4', sha256='3bc9c5b27eb1434f20d17bc1b75ddf3b3ea47924a8496dcc790be8f0a47d91a4',
            url='file://{0}/vmd-1.9.4a55.bin.LINUXAMD64-CUDA102-OptiX650-OSPRay185-RTXRTRT.opengl.tar.gz'.format(os.getcwd()))
